/* Seva — Step 4 follow-up: route notification clicks by purpose. Run AFTER 20260714120000. */

-- Status notifications belong on the list, where the role-appropriate action buttons and
-- "View & Chat" live. Message notifications go straight to the booking's chat.
-- 20260714120000 pointed all three at '/bookings/<id>'; only the link value changes here.
