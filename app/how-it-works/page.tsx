...
const faqs = [
  ...
  { q: 'What payment methods are accepted?', a: 'UPI (GPay, PhonePe, Paytm), debit/credit cards, and netbanking — all paid online, so the money lands in escrow. At checkout you will also see Cash and a Seva Wallet balance marked “Coming soon”: neither can be selected yet. Cash cannot be held in escrow, so we could not protect or refund it, and a prepaid customer balance is not built yet.' },
  { q: 'What is the Seva Wallet?', a: 'Two different things share that name. Today it is the payout ledger: providers receive their earnings there once you confirm a job is done, and any refund from a resolved dispute lands there too. A prepaid balance that you top up and spend is a separate, future feature — it appears at checkout marked “Coming soon” and cannot be selected. Neither is a savings or investment product, and neither pays interest.' },
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] pt-20">
      ...
      <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-400 mb-8">Book independent, ID-verified professionals near you — with your payment protected until the job is done.</p>
        <div className="flex flex-wrap gap-4 justify-center">
